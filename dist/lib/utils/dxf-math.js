 ...
 */
export function bulgeToArcPoints(p1, p2, bulge, segments) {
    ...
    const radius = Math.abs(((chordLength / 2) * (chordLength / 2) + sagitta * sagitta) / (2 * sagitta));
 ...
 */
export function tessellateArcRadians(options) {
 ...
 */
export function tessellateEllipse(options) {
 ...
 */
export function evaluateBSpline(degree, controlPoints, knots, weights, numPoints) {
 ...
 */
export function applyInsertTransform(options) {
...
//# sourceMappingURL=dxf-math.js.map